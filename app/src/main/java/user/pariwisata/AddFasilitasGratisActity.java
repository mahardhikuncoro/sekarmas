...
public class AddFasilitasGratisActity extends BaseDialogActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText("Tambah Fasilitas Gratis");
        progressBar.setVisibility(View.GONE);
        lnHarga.setVisibility(View.GONE);
    ...
    public void clickPost(){
        ...
        if (!networkConnection.isNetworkConnected()) {
            ...
            pariwisataEndpoint.addFasilitasWisataGratis("Bearer " + userdata.select().getAccesstoken(),request).enqueue(new Callback<PariwisataJson>() {
                @Override
