...
public class ActiveKey {
    ...
    public static final String GPS_SENDLOCATION_SERVICE_INTERVAL   = "GPS_SENDLOCATION_SERVICE_INTERVAL";
    ...
    public static final String CC                   = "Credit Committee";
    public static final String COL                  = "Collection";
    public static final String SVY                  = "Surveyor";
    public static final String MKT                  = "Marketing";
    public static final String TEAM_SUPPORT_WO      = "Team Support WO";
    public static final String TEAM_SUPPORT_CABANG  = "Team Support Cabang";
