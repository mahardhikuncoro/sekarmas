...
public class UpdateUmkm extends BaseDialogActivity {


    @BindView(R.id.btn_image_bar_loc)
    LinearLayout btnLocation;

    @BindView(R.id.tv_title_form)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_umkm);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        userdata = new Userdata(UpdateUmkm.this);
                ...
                public void onResponse(Call<UmkmModel> call, Response<UmkmModel> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (response.body().getProfilePicture() != null || !response.body().getProfilePicture().equals("")) {
                            ...
                            Picasso picasso = new Picasso.Builder(UpdateUmkm.this).downloader(new OkHttp3Downloader(picassoClient)).build();
    ...
    private void setadapterSektor(){
        SpinnerCostumeAdapter spinnerCostumeAdapter = new SpinnerCostumeAdapter(UpdateUmkm.this, sektorNames);
...
//            RequestBody userId = RequestBody.create(MediaType.parse("text/plain"), userdata.select().getId());
                ...
                public void onResponse(Call<UmkmCallback> call, Response<UmkmCallback> response) {
                    if(response.isSuccessful()){
                        if(response.body().getSuccess()) {
                            progressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(UpdateUmkm.this, "Data berhasil diperbaharui !", Toast.LENGTH_SHORT)
                                    .show();
    ...
    public void clickOpenGalery(){
        {
            Dialog choose = new AlertDialog.Builder(UpdateUmkm.this, AlertDialog.THEME_HOLO_LIGHT)
                    ...
                    .setItems(new String[]{"Camera", "Gallery"}, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int position) {
                            if (position == 0) {
                                ...
                                if (cameraIntent.resolveActivity(UpdateUmkm.this.getPackageManager()) != null) {
                                    File photoFIle = null;
                                    try {
                                    ...
                                    if (photoFIle != null) {
                                        if (Build.VERSION.SDK_INT >= 23) {
                                            photoURI = FileProvider.getUriForFile(UpdateUmkm.this,
                ...
                .setItems(new String[]{"Lokasi Sekarang", "Pilih dari peta"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            ...
                            Intent openMap = new Intent(UpdateUmkm.this, MapsDetailUmkmActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == REQUEST_GALLERY_CODE && resultCode == Activity.RESULT_OK) {
                uri = data.getData();
                String mimeType = "";
                mCurrentPhotoPath = getRealPathFromURIPath(uri, UpdateUmkm.this);
