...
public class CreateUmkm extends BaseDialogActivity {
...
//    TextView tvVideoTitle;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        userdata = new Userdata(CreateUmkm.this);
...
//        layoutVideoTitle.setVisibility(View.GONE);
    ...
    private void setadapterSektor(){
        SpinnerCostumeAdapter spinnerCostumeAdapter = new SpinnerCostumeAdapter(CreateUmkm.this, sektorNames);
                ...
                public void onResponse(Call<UmkmCallback> call, Response<UmkmCallback> response) {
                    if(response.isSuccessful()){
                        if(response.body().getData() != null) {
                            ...
                            Toast.makeText(CreateUmkm.this, "Data Berhasil diinput, silahkan input gambar !", Toast.LENGTH_SHORT)
                                    .show();
    ...
    public void clickOpenGalery(){
        {
            Dialog choose = new AlertDialog.Builder(CreateUmkm.this, AlertDialog.THEME_HOLO_LIGHT)
                    ...
                    .setItems(new String[]{"Camera", "Gallery"}, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int position) {
                            if (position == 0) {
                                ...
                                if (cameraIntent.resolveActivity(CreateUmkm.this.getPackageManager()) != null) {
                                    File photoFIle = null;
                                    try {
                                    ...
                                    if (photoFIle != null) {
                                        if (Build.VERSION.SDK_INT >= 23) {
                                            photoURI = FileProvider.getUriForFile(CreateUmkm.this,
                ...
                .setItems(new String[]{"Lokasi Sekarang", "Pilih dari peta"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            ...
                            Intent openMap = new Intent(CreateUmkm.this, MapsActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode != RESULT_CANCELED) {
            ...
            if (requestCode == REQUEST_GALLERY_CODE && resultCode == Activity.RESULT_OK) {
                uri = data.getData();
                String mimeType = "";
                mCurrentPhotoPath = getRealPathFromURIPath(uri, CreateUmkm.this);
